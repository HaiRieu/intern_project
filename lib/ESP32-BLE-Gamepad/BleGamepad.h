...
public:
    BleGamepad(std::string deviceName = " ", std::string deviceManufacturer = " ", uint8_t batteryLevel = 100, uint8_t batteryChargeStatus = 0);
    ...
    NimBLECharacteristic *IMU1RawData;
    NimBLECharacteristic *IMU2RawData;
    NimBLECharacteristic *IMU1FuseDataCaliStatus;
    NimBLECharacteristic *IMU2FuseDataCaliStatus;
    NimBLECharacteristic *FlexSensorData;
    NimBLECharacteristic *ForceSensorData;
    NimBLECharacteristic *OverallStatus;
    NimBLECharacteristic *Config;
    NimBLECharacteristic *UNIXTime;
    NimBLECharacteristic *Joystick;
    NimBLECharacteristic *Buttons;
    //custom setter getter for characteristics
    void setterCharacterData(NimBLECharacteristic *character, uint8_t *data, uint8_t length);
    void setUNIXTime(uint8_t *data, uint8_t length);
    void getcharacterData(NimBLECharacteristic *character, uint8_t *data);
    void resetFlagsWrite();
    void resetFlagsRead();
