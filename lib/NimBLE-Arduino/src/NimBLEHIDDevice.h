...
class NimBLEHIDDevice {
  public:
    ...
    void                  setBatteryChargeStatus(uint8_t state, bool notify = false);
    NimBLECharacteristic* getBatteryLevel();
    NimBLECharacteristic* getBatteryChargeStatus();
  ...
  private:
    ...
    NimBLECharacteristic* m_batteryChargeStatusChr{nullptr}; // 0x2a1a
};
